...
export const Home = () => {
  ...
  const listConcerts = async () => {
    await axios
      .get("https://eventsapp-backend-237b7b451647.herokuapp.com/concerts")
      .then((res) => {
        setEvent(res.data);
  ...
  const listFestivals = async () => {
    await axios
      .get("https://eventsapp-backend-237b7b451647.herokuapp.com/festivals")
      .then((res) => {
        setEvent(res.data);
        setNewEvents(res.data);
        setProgress(false);
  ...
  const listTheaters = async () => {
    await axios
      .get("https://eventsapp-backend-237b7b451647.herokuapp.com/theaters")
      .then((res) => {
        setEvent(res.data);
        setNewEvents(res.data);
        setProgress(false);
  ...
  const listStandUps = async () => {
    await axios
      .get("https://eventsapp-backend-237b7b451647.herokuapp.com/standups")
      .then((res) => {
        setEvent(res.data);
        setNewEvents(res.data);
        setProgress(false);
